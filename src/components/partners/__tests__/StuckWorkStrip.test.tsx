...
const stages: StuckStage[] = [
  { key: "brief", label: "Write brief", count: 6, unassigned: 0, medianDaysLate: 12 },
  { key: "briefQc", label: "Brief QC & client OK", note: "upstream QC", count: 11, unassigned: 0, medianDaysLate: 20 },
  { key: "casting", label: "Casting & intake", count: 15, unassigned: 0, medianDaysLate: 9 },
  { key: "assign", label: "Assign", count: 8, unassigned: 0, medianDaysLate: 30 },
  { key: "produce", label: "Produce", count: 12, unassigned: 8, medianDaysLate: 25 },
  { key: "revisions", label: "Revisions", count: 0, unassigned: 0, medianDaysLate: 0 },
  { key: "deliverableQc", label: "Deliverable QC", note: "downstream QC", count: 40, unassigned: 0, medianDaysLate: 14 },
  { key: "ship", label: "Ship", count: 38, unassigned: 0, medianDaysLate: 15 },
];
